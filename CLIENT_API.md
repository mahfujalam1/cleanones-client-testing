...
**Query params**: same as locations (`page`, `limit`, `searchTerm` matches name/room_type, `sort`).
...
```json
{
  ...
  "is_active": true,
  "room": { "_id": "66fb2a11bb22cc33dd44ee01", "name": "Conference Room A", "room_type": "meeting_room", "floor": 2 },
