...
const additions = {
  nl: {
    allShiftsOnSchedule: "Alle diensten op schema",
    blocks: `    roster: {
  ...
  pl: {
    allShiftsOnSchedule: "Wszystkie zmiany zgodnie z harmonogramem",
    blocks: `    roster: {
  ...
  uk: {
    allShiftsOnSchedule: "Всі зміни за розкладом",
    blocks: `    roster: {
  ...
  pt: {
    allShiftsOnSchedule: "Todos os turnos no horário",
    blocks: `    roster: {
  ...
  ar: {
    allShiftsOnSchedule: "جميع الورديات في موعدها",
    blocks: `    roster: {
  ...
  fr: {
    allShiftsOnSchedule: "Tous les shifts sont prévus",
    blocks: `    roster: {
  ...
  es: {
    allShiftsOnSchedule: "Todos los turnos a tiempo",
    blocks: `    roster: {
...
console.log("Translation additions applied.");
