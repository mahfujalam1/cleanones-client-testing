...
## 7. Quick checklist for the frontend team
...
- [ ] If you show notification icons/labels keyed by `type`, add `SHIFT_WORKER_ASSIGNED`/`SHIFT_WORKER_REMOVED` and drop the old `CLEANING_PLAN_WORKER_*` ones.
